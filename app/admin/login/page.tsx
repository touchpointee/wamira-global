...
export default function AdminLoginPage() {
  ...
  return (
    <section className="min-h-screen bg-luxury-radial px-5 pb-20 pt-36 text-center">
      <p className="text-xs font-bold uppercase tracking-[0.28em] text-gold-champagne">Wamira Global</p>
      <h1 className="mt-4 font-serif text-5xl text-teal-deep md:text-6xl">Admin Portal</h1>
