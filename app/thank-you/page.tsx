...
export default function ThankYouPage() {
  return (
    <section className="grid min-h-screen place-items-center bg-luxury-radial px-5 pt-24 text-center">
      <div>
        <div className="mx-auto grid h-28 w-28 place-items-center rounded-full border border-gold-champagne text-gold-champagne">
          <Check className="h-16 w-16" />
        </div>
        <h1 className="mt-8 font-serif text-6xl text-gold-champagne">Thank You!</h1>
